        ...
        <div>
            ...
            <div className="uk-margin">
                ...
                <div className="uk-form-controls">
                    <input onChange={props.handleInputChange} className="uk-input" name="successorMentee" id="successorMentee" type="text" placeholder="" />
                </div>
            </div>
            <div className="uk-margin">
                <label className="uk-form-label" htmlFor="planGraduate">Bạn có kế hoạch gì sau khi hoàn tất việc học ?</label>
                <div className="uk-form-controls">
                    <input onChange={props.handleInputChange} className="uk-input" name="planGraduate" id="planGraduate" type="text" placeholder="" />
                </div>
            </div>
            <div className="uk-margin">
                <label className="uk-form-label" htmlFor="whyhelpMentee">Tại sao VAY nên hỗ trợ cho bạn ?</label>
                <div className="uk-form-controls">
                    <input onChange={props.handleInputChange} className="uk-input" name="whyhelpMentee" id="whyhelpMentee" type="text" placeholder="" />
                </div>
            </div>
            <div className="uk-margin">
                <label className="uk-form-label" htmlFor="ifnotMentee">Bạn sẽ làm gì nếu không nhận được sự hỗ trợ từ VAY?</label>
                <div className="uk-form-controls">
                    <input onChange={props.handleInputChange} className="uk-input" name="ifnotMentee" id="ifnotMentee" type="text" placeholder="" />
                </div>
            </div>
            <div className="uk-form-controls">
                ...
                <div className="uk-form-controls">
                    <input onChange={props.handleInputChange} className="uk-input" name="donateMentee" id="donateMentee" type="text" placeholder="" />
                </div>
            </div>
        </div>
    )
