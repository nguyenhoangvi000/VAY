...
export const StepSix = (props) => {
    return (
        <div>
            ...
            <div className="uk-form-controls">
                <p className="uk-form-label uk-text-break">Bạn đã gửi đường link Reference Form cho người giới thiệu chưa? <a target="_blank" rel="noopener noreferrer" href="https://docs.google.com/forms/d/13cvtEX5D5DqdCmTB7ayOKIdr7P4nrKMEcvvBsA481hc/edit?ts=5a5b24b4">https://docs.google.com/forms/d/13cvtEX5D5DqdCmTB7ayOKIdr7P4nrKMEcvvBsA481hc/edit?ts=5a5b24b4</a></p>
                ...
                <label className="uk-form-label"><input onChange={props.handleInputChange} className="uk-radio" id="radioNotAgreeSendLinkToPresenter" name="radioAgreeSendLinkToPresenter" type="radio" value="No" /> Tôi không đồng ý</label>
            </div>
        </div>
    )
}