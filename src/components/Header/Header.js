...
export default class Header extends Component {
  ...
  render() {
    return ( <div className = "header-container" >
      ...
      a className = "nav-link uk-button-text"
      href = "/#about-us" > Về chúng tôi < /a> < /
      li > <
      li className = "nav-item" > { /* onClick={() => { goToAnchor('our-services'); }} */ } <
      a className = "nav-link uk-button-text"
      href = "/#our-services" > Mô hình < /a> < /
      li > <
      ...
      className = "nav-link uk-button-text" > Liên hệ < /a> < /
      li > <
      /ul> < /
      div > <
      /div> < /
